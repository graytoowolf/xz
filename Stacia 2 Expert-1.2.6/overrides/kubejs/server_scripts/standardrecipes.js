...
materials.forEach(function(material) {
  ...
  event.remove({type: 'minecraft:crafting_shaped', output: '#forge:rods/iron'})
    ...
    var materials8 = ["brass", "copper", "tin", "lead", "uranium", "iridium", "enderium", "bronze", "gold", "steel", "aluminum","diamond", "emerald"];
...
materials20.forEach(function(material) {
    event.shapeless('thermal:' + material + '_plate', ['immersiveengineering:hammer', '#forge:ingots/' + material,'#forge:ingots/' + material])
});
...
materials21.forEach(function(material) {
  event.shapeless('thermal_extra:' + material + '_plate', ['immersiveengineering:hammer', '#forge:ingots/' + material,'#forge:ingots/' + material])
});
...
materials22.forEach(function(material) {
  event.shapeless('immersiveengineering:plate_' + material, ['immersiveengineering:hammer', '#forge:ingots/' + material,'#forge:ingots/' + material])
});

  event.shapeless('ftbic:iridium_plate', ['immersiveengineering:hammer', '#forge:ingots/iridium','#forge:ingots/iridium'])
  ...
  materials23.forEach(function(material) {
    event.shapeless('ad_astra:' + material + '_plate', ['immersiveengineering:hammer', '#forge:ingots/' + material,'#forge:ingots/' + material])
  });
...
materials40.forEach(function(material) {
  event.shapeless('kubejs:plate_' + material, ['immersiveengineering:hammer', '#forge:gemingot/' + material,'#forge:gemingot/' + material])
});
...
event.recipes.immersiveengineeringMetalPress('2x redstone_arsenal:obsidian_rod', 'minecraft:obsidian', 'immersiveengineering:mold_rod')
...
event.custom({
  ...
  event.custom({
    ...
    event.custom({"type":"mekanism:enriching","input":{"ingredient":{"tag":"forge:storage_blocks/charcoal_coal"}},"output":{"count":9, "item":"mekanism:enriched_carbon"}})
    ...
    var materials112 = [
      ...
      "aluminum",
      "uranium",
      "soul_infused", "shellite", "twinite", "dragonsteel", "darksteel", "diamond", "lapis", "tin", "lead", "silver", "nickel", "bronze", "electrum", "invar", "constantan", "zinc", "iridium", "steel", "rose_gold", "prismalium", "melodium", "stellarium", "desh", "ostrum", "calorite", "brass",
    ];
    ...
    materials113.forEach(function(material) {
      event.shapeless(
        Item.of("minecraft:" + material + "_planks", 2), // output
        [ "#minecraft:" + material + "_logs"] //input
      );
    });

    event.remove({ id: 'minecraft:warped_planks' });
    event.shapeless(Item.of('minecraft:warped_planks', 2), ['#minecraft:warped_stems']);

    event.remove({ id: 'minecraft:crimson_planks' });
    event.shapeless(Item.of('minecraft:crimson_planks', 2), ['#minecraft:crimson_stems']);

//--------Nests

event.remove({ output: ['productivebees:oak_wood_nest', 'productivebees:spruce_wood_nest', 'productivebees:dark_oak_wood_nest', 'productivebees:birch_wood_nest', 'productivebees:jungle_wood_nest', 'productivebees:acacia_wood_nest', 'productivebees:stone_nest', 'productivebees:coarse_dirt_nest', 'productivebees:sand_nest', 'productivebees:nether_brick_nest', 'productivebees:nether_gold_nest', 'productivebees:nether_quartz_nest', 'productivebees:soul_sand_nest', 'productivebees:glowstone_nest', 'productivebees:slimy_nest', 'productivebees:sugar_cane_nest', 'productivebees:gravel_nest', 'productivebees:snow_nest', 'productivebees:bumble_bee_nest', 'productivebees:obsidian_nest', 'productivebees:end_stone_nest'] });
let nest = (output, pottedInput) => {
  event.custom({
    ...
    "result": {
      "item": "productivebees:" + output + "_nest"
    }
  })
...
nest('oak_wood', 'minecraft:oak_log')
nest('spruce_wood', 'minecraft:spruce_log')
nest('dark_oak_wood', 'minecraft:dark_oak_log')
nest('birch_wood', 'minecraft:birch_log')
nest('jungle_wood', 'minecraft:jungle_log')
nest('acacia_wood', 'minecraft:acacia_log')
nest('stone', 'minecraft:stone')
nest('coarse_dirt', 'minecraft:coarse_dirt')
nest('sand', 'minecraft:sand')
nest('snow', 'minecraft:snow_block')
nest('gravel', 'minecraft:gravel')
nest('sugar_cane', 'minecraft:sugar_cane')
nest('slimy', 'minecraft:slime_block')
nest('glowstone', 'minecraft:glowstone')
nest('soul_sand', 'minecraft:soul_sand')
nest('nether_quartz', 'minecraft:nether_quartz_ore')
nest('nether_gold', 'minecraft:nether_gold_ore')
nest('nether_brick', 'minecraft:nether_bricks')
nest('end_stone', 'minecraft:end_stone')
nest('obsidian', 'minecraft:obsidian')
nest('bumble_bee', 'minecraft:grass_block')
