ServerEvents.recipes(event => {
    ...
    event.custom({
        "type": "mekanism:metallurgic_infusing",
        "chemicalInput": { "amount": 2, "infuse_type": "kubejs:enderium" },
        "itemInput":
    ...
    event.custom({
        "type": "mekanism:metallurgic_infusing",
        "chemicalInput": { "amount": 10, "infuse_type": "kubejs:black_quartz" },
        "itemInput":
    ...
    event.custom({
        "type": "mekanism:metallurgic_infusing",
        "chemicalInput": { "amount": 90, "infuse_type": "kubejs:black_quartz" },
        "itemInput":
            {"ingredient": {"item": "minecraft:iron_block"}},
        "output": {"item": "pneumaticcraft:compressed_iron_block", "count": 1}
    })

    event.custom({
        "type": "mekanism:metallurgic_infusing",
        "chemicalInput": { "amount": 810, "infuse_type": "kubejs:black_quartz" },
        "itemInput":
            {"ingredient": {"item": "compressium:iron_1"}},
        "output": {"item": "pneumaticcraft:compressed_iron_block", "count": 9}
    })
})