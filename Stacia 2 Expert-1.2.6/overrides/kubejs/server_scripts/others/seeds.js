...
pottingtier2('saltpeter', 'thermal:niter_block')
...
pottingtier3('amethyst_bronze', 'tconstruct:amethyst_bronze_block')
pottingtier3('pig_iron', 'tconstruct:pig_iron_block')
pottingtier3('slimesteel', 'tconstruct:slimesteel_block')
...
pottingtier4('signalum', 'thermal:signalum_block')
...
pottingtier4('cobalt', 'tconstruct:cobalt_block')
pottingtier4('rose_gold', 'thermal:rose_gold_block')
...
pottingtier5('spirited_crystal', 'powah:spirited_crystal_block')
pottingtier5('uraninite', 'powah:uraninite_block')
pottingtier5('manyullyn', 'tconstruct:manyullyn_block')
pottingtier5('queens_slime', 'tconstruct:queens_slime_block')
...
//-------animalstier2
let animalstier2 = (output, pottedInput) => {
  e.custom({
    "type": "mysticalagriculture:infusion","conditions": [{"type": "mysticalagriculture:augment_enabled","augment": "kubejs:tier2_crafting_seed"},{"type": "mysticalagriculture:augment_enabled","augment": "mysticalagriculture:nature_seeds"}],
    "input": {"item": "kubejs:tier2_crafting_seed"},
    "ingredients": [
...
animalstier2('pig', 'minecraft:porkchop')
animalstier2('chicken', 'reliquary:angelic_feather')
animalstier2('cow', 'immersiveengineering:ersatz_leather')
animalstier2('sheep', 'thermal:white_rockwool')
animalstier2('squid', 'minecraft:ink_sac')
animalstier2('fish', 'pamhc2foodextended:fishdinneritem')
animalstier2('slime', 'thermal:slime_mushroom_spores')
animalstier2('turtle', 'minecraft:scute')

//-------animalstier3
let animalstier3 = (output, pottedInput) => {
  e.custom({
    "type": "mysticalagriculture:infusion","conditions": [{"type": "mysticalagriculture:augment_enabled","augment": "kubejs:tier2_crafting_seed"},{"type": "mysticalagriculture:augment_enabled","augment": "mysticalagriculture:nature_seeds"}],
    "input": {"item": "kubejs:tier3_crafting_seed"},
    "ingredients": [
...
animalstier3('zombie', 'reliquary:zombie_heart')
animalstier3('skeleton', 'reliquary:rib_bone')
animalstier3('creeper', 'reliquary:catalyzing_gland')
animalstier3('spider', 'reliquary:chelicerae')
animalstier3('rabbit', 'minecraft:rabbit_hide')
animalstier3('blitz', 'thermal:blitz_powder')
animalstier3('blizz', 'thermal:blizz_powder')
animalstier3('basalz', 'thermal:basalz_powder')

//-------animalstier4
let animalstier4 = (output, pottedInput) => {
  e.custom({
    "type": "mysticalagriculture:infusion","conditions": [{"type": "mysticalagriculture:augment_enabled","augment": "kubejs:tier2_crafting_seed"},{"type": "mysticalagriculture:augment_enabled","augment": "mysticalagriculture:nature_seeds"}],
    "input": {"item": "kubejs:tier4_crafting_seed"},
    "ingredients": [
...
animalstier4('blaze', 'exnihilosequentia:blaze_doll')
animalstier4('ghast', 'minecraft:ghast_tear')
animalstier4('enderman', 'rftoolsbase:infused_enderpearl')

//-------animalstier5
let animalstier5 = (output, pottedInput) => {
  e.custom({
    "type": "mysticalagriculture:infusion","conditions": [{"type": "mysticalagriculture:augment_enabled","augment": "kubejs:tier2_crafting_seed"},{"type": "mysticalagriculture:augment_enabled","augment": "mysticalagriculture:nature_seeds"}],
    "input": {"item": "kubejs:tier5_crafting_seed"},
    "ingredients": [
...
animalstier5('wither_skeleton', 'mob_grinding_utils:rotten_egg')
animalstier5('hepatizon', 'tconstruct:hepatizon_block')
