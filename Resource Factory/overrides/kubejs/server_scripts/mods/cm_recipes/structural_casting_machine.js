ServerEvents.recipes(event => {
    ...
    const structure1Pattern = [
        ["abbba", "bcccb", "bdefb", "bcccb", "abbba"],
        ["bghgb", "g   g", "h   h", "g   g", "bghgb"],
        ["bhghb", "h   h", "g   g", "h   h", "bhghb"],
        ["bghgb", "g   g", "h   h", "g   g", "bghgb"],
        ["abbba", "bcccb", "bdefb", "bcccb", "abbba"],
        ["     ", "     ", "  m  ", "     ", "     "]
    ];
    const structure1Keys = {
        ...
        "e": "pneumaticcraft:smooth_plastic_brick_white",
        "f": "pneumaticcraft:smooth_plastic_brick_white",
