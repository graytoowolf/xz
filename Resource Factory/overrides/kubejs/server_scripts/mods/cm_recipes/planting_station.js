const plant =
    [
        ['mysticalagriculture:armadillo_seeds', 'mysticalagriculture:armadillo_essence'],
        ['mysticalagriculture:breeze_seeds', 'mysticalagriculture:breeze_essence'],
        ['mysticalagriculture:conductive_alloy_seeds', 'mysticalagriculture:conductive_alloy_essence'],
        ['mysticalagriculture:copper_alloy_seeds', 'mysticalagriculture:copper_alloy_essence'],
        ...
        ['mysticalagriculture:hop_graphite_seeds', 'mysticalagriculture:hop_graphite_essence'],
        ['mysticalagriculture:nitro_crystal_seeds', 'mysticalagriculture:nitro_crystal_essence'],
        ['mysticalagriculture:peridot_seeds', 'mysticalagriculture:peridot_essence'],
        ['mysticalagriculture:pulsating_alloy_seeds', 'mysticalagriculture:pulsating_alloy_essence'],
        ...
        ['mysticalagriculture:soulium_seeds', 'mysticalagriculture:soulium_essence'],
        ['mysticalagriculture:vibrant_alloy_seeds', 'mysticalagriculture:vibrant_alloy_essence'],
        ['mysticalagriculture:nether_star_seeds', 'mysticalagriculture:nether_star_essence'],
        ['mysticalagriculture:netherite_seeds', 'mysticalagriculture:netherite_essence'],
        ...
        ['mysticalagriculture:inferium_seeds', 'mysticalagriculture:inferium_essence'],
        ['mysticalagriculture:zombie_seeds', 'mysticalagriculture:zombie_essence'],
        ['mysticalagriculture:energized_steel_seeds', 'mysticalagriculture:energized_steel_essence'],
        ...
        ['mysticalagriculture:compressed_iron_seeds', 'mysticalagriculture:compressed_iron_essence'],
        ...
        ['mysticalagriculture:refined_glowstone_seeds', 'mysticalagriculture:refined_glowstone_essence'],
        ...
        ['mysticalagriculture:uraninite_seeds', 'mysticalagriculture:uraninite_essence'],
        ...
        ['mysticalagriculture:fluorite_seeds', 'mysticalagriculture:fluorite_essence'],
        ...
        ['mysticalagriculture:prismarine_seeds', 'mysticalagriculture:prismarine_essence'],
        ['mysticalagriculture:turtle_seeds', 'mysticalagriculture:turtle_essence'],
        ['mysticalagriculture:deepslate_seeds', 'mysticalagriculture:deepslate_essence'],
        ['mysticalagriculture:fire_seeds', 'mysticalagriculture:fire_essence'],
        ['mysticalagriculture:blazing_crystal_seeds', 'mysticalagriculture:blazing_crystal_essence'],
        ...
        ['mysticalagriculture:coral_seeds', 'mysticalagriculture:coral_essence'],
        ...
        ['mysticalagriculture:amethyst_seeds', 'mysticalagriculture:amethyst_essence'],
        ['mysticalagriculture:fluix_seeds', 'mysticalagriculture:fluix_essence'],
        ['mysticalagriculture:spirited_crystal_seeds', 'mysticalagriculture:spirited_crystal_essence'],
        ...
        ['mysticalagriculture:honey_seeds', 'mysticalagriculture:honey_essence'],
        ...
        ['mysticalagriculture:niotic_crystal_seeds', 'mysticalagriculture:niotic_crystal_essence'],
        ...
        ['mysticalagriculture:fish_seeds', 'mysticalagriculture:fish_essence'],
        ['mysticalagriculture:obsidian_seeds', 'mysticalagriculture:obsidian_essence'],
        ['mysticalagriculture:squid_seeds', 'mysticalagriculture:squid_essence'],
        ['mysticalagriculture:dragon_egg_seeds', 'mysticalagriculture:dragon_egg_essence'],
...
const plant2 =
    [
        ...
        ['occultism:datura_seeds', 'occultism:datura'],
        ['actuallyadditions:coffee_beans', 'actuallyadditions:coffee_beans'],
        ...
        ['actuallyadditions:flax_seeds', 'minecraft:string'],
        ...
        ['ars_nouveau:sourceberry_bush', 'ars_nouveau:sourceberry_bush']
    ]
const log =
    [
...
ServerEvents.recipes(event => {
    ...
    plant.forEach(([seeds, essence]) => {

        custommachinery.custom_machine("minecraft:planting_station", 80)
            .requireEnergyPerTick(1000)
            .requireFluid("50x water")
            .requireFluid('1x industrialforegoing:ether_gas')
            .requireItem(seeds).chance(0)
            .produceItem(`3x ${essence}`)
    });
    plant2.forEach(([seeds, output]) => {
        custommachinery.custom_machine("minecraft:planting_station", 80)
            .requireEnergy(8192)
            .requireFluid("100x water")
            .requireFluid("10x #c:experience")
            .requireItem(seeds).chance(0)
            .produceItem(`8x ${output}`)
    });
    log.forEach(([seeds, output]) => {
        custommachinery.custom_machine("minecraft:planting_station", 80)
            .requireEnergy(8192)
            .requireFluid("100x water")
            .requireFluid("10x #c:experience")
            .requireItem(seeds).chance(0)
            .produceItem(`16x ${output}`)
    });
})
